...
var QueryClient = class {
	...
	*/
	refetchQueries(arg1, arg2, arg3) {
		...
		if (!(options != null && options.throwOnError)) promise = promise.catch(noop$1);
		return promise;
	}
	/**
	* @deprecated This method should be used with only one object argument.
...
//#endregion
//#region node_modules/@tanstack/query-core/build/lib/queryObserver.mjs
var QueryObserver = class extends Subscribable {
	...
	setOptions(options, notifyOptions) {
		...
		if (!shallowEqualObjects(prevOptions, this.options)) this.client.getQueryCache().notify({
	...
	executeFetch(fetchOptions) {
		...
		if (!(fetchOptions != null && fetchOptions.throwOnError)) promise = promise.catch(noop$1);
		return promise;
	}
	updateStaleTimeout() {
		this.clearStaleTimeout();
		if (isServer || this.currentResult.isStale || !isValidTimeout(this.options.staleTime)) return;
		const timeout = timeUntilStale(this.currentResult.dataUpdatedAt, this.options.staleTime) + 1;
...
//#endregion
//#region node_modules/@tanstack/query-core/build/lib/queriesObserver.mjs
...
//#endregion
//#region node_modules/@tanstack/query-core/build/lib/infiniteQueryObserver.mjs
...
//#endregion
//#region node_modules/@tanstack/query-core/build/lib/mutationObserver.mjs
var MutationObserver = class extends Subscribable {
	...
	setOptions(options) {
		...
		if (!shallowEqualObjects(prevOptions, this.options)) this.client.getMutationCache().notify({
			type: "observerOptionsUpdated",
...
//#endregion
//#region node_modules/@tanstack/query-core/build/lib/hydration.mjs
...
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/useSyncExternalStore.mjs
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var useSyncExternalStore = require_shim().useSyncExternalStore;
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/QueryClientProvider.mjs
var defaultContext = /* @__PURE__ */ import_react.createContext(void 0);
var QueryClientSharingContext = /* @__PURE__ */ import_react.createContext(false);
...
var useQueryClient = ({ context } = {}) => {
	const queryClient = import_react.useContext(getQueryClientContext(context, import_react.useContext(QueryClientSharingContext)));
	if (!queryClient) throw new Error("No QueryClient set, use QueryClientProvider to set one");
	return queryClient;
};
var QueryClientProvider = ({ client, children, context, contextSharing = false }) => {
	...
	return /* @__PURE__ */ import_react.createElement(QueryClientSharingContext.Provider, { value: !context && contextSharing }, /* @__PURE__ */ import_react.createElement(Context.Provider, { value: client }, children));
};
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/isRestoring.mjs
var IsRestoringContext = /* @__PURE__ */ import_react.createContext(false);
var useIsRestoring = () => import_react.useContext(IsRestoringContext);
var IsRestoringProvider = IsRestoringContext.Provider;
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/QueryErrorResetBoundary.mjs
...
var QueryErrorResetBoundaryContext = /* @__PURE__ */ import_react.createContext(createValue());
...
var QueryErrorResetBoundary = ({ children }) => {
	...
	return /* @__PURE__ */ import_react.createElement(QueryErrorResetBoundaryContext.Provider, { value }, typeof children === "function" ? children(value) : children);
};
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/utils.mjs
function shouldThrowError(_useErrorBoundary, params) {
	if (typeof _useErrorBoundary === "function") return _useErrorBoundary(...params);
	return !!_useErrorBoundary;
}
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/errorBoundaryUtils.mjs
...
var getHasError = ({ result, errorResetBoundary, useErrorBoundary, query }) => {
	return result.isError && !errorResetBoundary.isReset() && !result.isFetching && shouldThrowError(useErrorBoundary, [result.error, query]);
};
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/suspense.mjs
/**
...
var fetchOptimistic = (defaultedOptions, observer, errorResetBoundary) => observer.fetchOptimistic(defaultedOptions).then(({ data }) => {
...
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/useQueries.mjs
function useQueries({ queries, context }) {
	const queryClient = useQueryClient({ context });
	const isRestoring = useIsRestoring();
	const errorResetBoundary = useQueryErrorResetBoundary();
	const defaultedQueries = import_react.useMemo(() => queries.map((options) => {
	...
	const [observer] = import_react.useState(() => new QueriesObserver(queryClient, defaultedQueries));
	const optimisticResult = observer.getOptimisticResult(defaultedQueries);
	useSyncExternalStore(import_react.useCallback((onStoreChange) => isRestoring ? () => void 0 : observer.subscribe(notifyManager.batchCalls(onStoreChange)), [observer, isRestoring]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
	import_react.useEffect(() => {
		observer.setQueries(defaultedQueries, { listeners: false });
	}, [defaultedQueries, observer]);
	const suspensePromises = optimisticResult.some((result, index) => shouldSuspend(defaultedQueries[index], result, isRestoring)) ? optimisticResult.flatMap((result, index) => {
		const options = defaultedQueries[index];
		const queryObserver = observer.getObservers()[index];
		if (options && queryObserver) {
			if (shouldSuspend(options, result, isRestoring)) return fetchOptimistic(options, queryObserver, errorResetBoundary);
			else if (willFetch(result, isRestoring)) fetchOptimistic(options, queryObserver, errorResetBoundary);
		}
		return [];
	}) : [];
...
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/useBaseQuery.mjs
function useBaseQuery(options, Observer) {
	...
	useClearResetErrorBoundary(errorResetBoundary);
	const [observer] = import_react.useState(() => new Observer(queryClient, defaultedOptions));
	const result = observer.getOptimisticResult(defaultedOptions);
	useSyncExternalStore(import_react.useCallback((onStoreChange) => {
	...
	if (shouldSuspend(defaultedOptions, result, isRestoring)) throw fetchOptimistic(defaultedOptions, observer, errorResetBoundary);
	if (getHasError({
		result,
		errorResetBoundary,
...
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/useQuery.mjs
function useQuery(arg1, arg2, arg3) {
	return useBaseQuery(parseQueryArgs(arg1, arg2, arg3), QueryObserver);
}
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/useSuspenseQuery.mjs
...
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/useSuspenseInfiniteQuery.mjs
...
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/useSuspenseQueries.mjs
...
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/queryOptions.mjs
function queryOptions(options) {
	return options;
}
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/infiniteQueryOptions.mjs
function infiniteQueryOptions(options) {
	return options;
}
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/Hydrate.mjs
function useHydrate(state, options = {}) {
	const queryClient = useQueryClient({ context: options.context });
	const optionsRef = import_react.useRef(options);
	optionsRef.current = options;
	import_react.useMemo(() => {
		if (state) hydrate(queryClient, state, optionsRef.current);
	}, [queryClient, state]);
}
var Hydrate = ({ children, options, state }) => {
	useHydrate(state, options);
	return children;
};
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/useIsFetching.mjs
function useIsFetching(arg1, arg2, arg3) {
	const [filters, options = {}] = parseFilterArgs(arg1, arg2, arg3);
	const queryClient = useQueryClient({ context: options.context });
	const queryCache = queryClient.getQueryCache();
	return useSyncExternalStore(import_react.useCallback((onStoreChange) => queryCache.subscribe(notifyManager.batchCalls(onStoreChange)), [queryCache]), () => queryClient.isFetching(filters), () => queryClient.isFetching(filters));
}
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/useIsMutating.mjs
function useIsMutating(arg1, arg2, arg3) {
	const [filters, options = {}] = parseMutationFilterArgs(arg1, arg2, arg3);
	const queryClient = useQueryClient({ context: options.context });
	const mutationCache = queryClient.getMutationCache();
	return useSyncExternalStore(import_react.useCallback((onStoreChange) => mutationCache.subscribe(notifyManager.batchCalls(onStoreChange)), [mutationCache]), () => queryClient.isMutating(filters), () => queryClient.isMutating(filters));
}
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/mutationOptions.mjs
function mutationOptions(options) {
	return options;
}
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/useMutation.mjs
function useMutation(arg1, arg2, arg3) {
	const options = parseMutationArgs(arg1, arg2, arg3);
	const queryClient = useQueryClient({ context: options.context });
	const [observer] = import_react.useState(() => new MutationObserver(queryClient, options));
	import_react.useEffect(() => {
		observer.setOptions(options);
	}, [observer, options]);
	const result = useSyncExternalStore(import_react.useCallback((onStoreChange) => observer.subscribe(notifyManager.batchCalls(onStoreChange)), [observer]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
	const mutate = import_react.useCallback((variables, mutateOptions) => {
		observer.mutate(variables, mutateOptions).catch(noop);
	}, [observer]);
	if (result.error && shouldThrowError(observer.options.useErrorBoundary, [result.error])) throw result.error;
	return {
		...result,
		mutate,
...
function noop() {}
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/useInfiniteQuery.mjs
function useInfiniteQuery(arg1, arg2, arg3) {
	return useBaseQuery(parseQueryArgs(arg1, arg2, arg3), InfiniteQueryObserver);
}
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/usePrefetchQuery.mjs
function usePrefetchQuery(options) {
	const client = useQueryClient();
	if (!client.getQueryState(options.queryKey)) client.prefetchQuery(options);
}
//#endregion
//#region node_modules/@tanstack/react-query/build/lib/usePrefetchInfiniteQuery.mjs
function usePrefetchInfiniteQuery(options) {
	const client = useQueryClient();
	if (!client.getQueryState(options.queryKey)) client.prefetchInfiniteQuery(options);
}
//#endregion
export { CancelledError, Hydrate, InfiniteQueryObserver, IsRestoringProvider, MutationCache, MutationObserver, QueriesObserver, Query, QueryCache, QueryClient, QueryClientProvider, QueryErrorResetBoundary, QueryObserver, defaultContext, defaultShouldDehydrateMutation, defaultShouldDehydrateQuery, dehydrate, focusManager, hashQueryKey, hydrate, infiniteQueryOptions, isCancelledError, isError, isServer, matchQuery, mutationOptions, notifyManager, onlineManager, parseFilterArgs, parseMutationArgs, parseMutationFilterArgs, parseQueryArgs, queryOptions, replaceEqualDeep, useHydrate, useInfiniteQuery, useIsFetching, useIsMutating, useIsRestoring, useMutation, usePrefetchInfiniteQuery, usePrefetchQuery, useQueries, useQuery, useQueryClient, useQueryErrorResetBoundary, useSuspenseInfiniteQuery, useSuspenseQueries, useSuspenseQuery };
